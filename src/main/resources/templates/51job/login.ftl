...
<body>
    ...
    <script>
         ...
         */
        function getCode() {
            document.getElementById("verifyimg").src = timestamp("http://localhost:8086/verifyCode/verifyCodeBySelf");
        }

        function getVerifyCode() {
            document.getElementById("testGraphics").src = timestamp("http://localhost:8086/testGraphics?imageType=1");
        }
        //为url添加时间戳
