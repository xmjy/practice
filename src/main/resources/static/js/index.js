...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      // S.UI.simulate('#rectangle|#countdown 3|小锅锅|你|真的|好帅|');
      // S.UI.simulate('#rectangle|小欣欣|高考加油哦！|');
      S.UI.simulate('#rectangle|2|3！|');
      // S.UI.simulate('小欣欣|高考加油哦！');
    }
